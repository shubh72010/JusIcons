...
[![Release](https://img.shields.io/github/v/release/shubh72010/JusIcons?label=release)](https://github.com/shubh72010/JusIcons/releases/tag/v0.3.2)
...
```bash
adb install https://github.com/shubh72010/JusIcons/releases/download/v0.3.2/app-release.apk
